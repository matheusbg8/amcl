...
//  cout << "Particles: " << set->sample_count << endl;
...
//    cout << self->pose.v[0] << " , " << self->pose.v[1]
//         << endl
//         << pose.v[0] << " , " << pose.v[1]
//         << endl
//         << self->map->origin_x << " , " << self->map->origin_y
//         << endl << endl;
...
double AMCLLaser::QuadNetModel(AMCLLaserData *data, pf_sample_set_t *set)
{
  AMCLLaser *self;
  int i, j, step;
  double z, pz;
